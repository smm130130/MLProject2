...
class trainMultinomialNBSPAM
{
	public static void main(String[] args) throws Exception
	{
		...
		trainMultinomialSpam t=new trainMultinomialSpam(argu[0],argu[1]);
		
		
	}
}
class  trainMultinomialSpam
{
	...
	String[] testDatapaths=new String[1];
	...
	double prior;	
	//int finalClass;
		public trainMultinomialSpam(String directoryPath,String testPath) throws Exception
		{
		...
		/* Total vocabulary:B  totalDocs:n */	
			...
			long initTime=System.currentTimeMillis();
				...
				System.out.println("The negative "+negative);*/
					...
					System.out.println("The time taken by Naive-Bayes on Test Set(Spam) "+(endTime-initTime));
