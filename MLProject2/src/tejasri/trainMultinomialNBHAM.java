...
class trainMultinomialNBHAM
{
	public static void main(String[] args) throws Exception
	{
		...
		trainMultinomialham t=new trainMultinomialham(argu[0],argu[1]);
		
		
	}
}
class  trainMultinomialham
{
	...
	double prior;	
	//int finalClass;
		public trainMultinomialham(String directoryPath,String testPath) throws Exception
		{
		...
		/* Total vocabulary:B  totalDocs:n */	
			...
			long initTime=System.currentTimeMillis();
				...
				System.out.println("The negative "+negative);*/
					...
					System.out.println("The time taken by Naive-Bayes on Test Set(Only Ham) "+(endTime-initTime));
